...
var args = [
  ...
  [['--auto-accept-alerts'], {
    required: false
  , dest: 'autoAcceptAlerts'
  , defaultValue: false
  , help: 'Accept iOS privacy access permission alerts (e.g., location, contacts, photos) automatically if they pop up. Default is false.'
  , example: true
  }],

  [['--auto-dismiss-alerts'], {
    required: false
  , dest: 'autoDismissAlerts'
  , defaultValue: false
  , help: 'Dismiss iOS privacy access permission alerts (e.g., location, contacts, photos) automatically if they pop up. Default is false.'
  , example: true
  }]
